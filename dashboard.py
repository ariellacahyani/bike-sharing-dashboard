...
# Load Dataset
df = pd.read_csv(r"C:\PROJECT\Machine_Learning\Dicoding\Bike Sharing Analysis\day.csv")
hour_df = pd.read_csv(r"C:\PROJECT\Machine_Learning\Dicoding\Bike Sharing Analysis\hour.csv")
